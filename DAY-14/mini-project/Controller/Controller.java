...
import com.demo.project.Service.SignupService;
...
public class Controller {
    ...
    @Autowired
    public Controller(SignupService userService) {
    ...
    public ResponseEntity<LoginSignup> registerUser(@RequestBody LoginSignup user) {
    	LoginSignup createdUser = userService.createUser(user.getName(), user.getEmail(), user.getPassword(),user.getAddress());
