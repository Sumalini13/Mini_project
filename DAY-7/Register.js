...
function Register() {
  ...
  return (
    ...
    <div className="testbox">
      <form action="/">
     <center><h1><u>User Account</u></h1></center><hr></hr>
    ...
    <div className="k">
         <p> By clicking Register, you agree to our <br></br></p></div>
         <center> <a href="#">terms and conditions</a>.</center>
    
        <button><Link to ="/homepage"><p>Register</p></Link></button>
